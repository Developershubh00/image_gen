...
api_key = '4f89d704-5a89-41ea-b687-608be765bd9f'
api_url = 'https://app.leonardo.ai/api/v1/images'

def extract_keywords(prompt_text):
    # You can implement your keyword extraction logic here based on your use case
    # For simplicity, we'll split the prompt text into words and consider each word as a keyword
